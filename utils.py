...
def generation_feature_10x(image_path, ori_spatial, fill_spatial):
    ...
    sample_features_336 = UNI_features(img_path=image_path, spatial=ori_spatial, patch_size=336)


    fill_features_112 = UNI_features(img_path=image_path, spatial=fill_spatial, patch_size=112)
    fill_features_336 = UNI_features(img_path=image_path, spatial=fill_spatial, patch_size=336)



    sample_features = {"sample_features_112": sample_features_112,  "sample_features_336": sample_features_336}
    fill_features = {"fill_features_112": fill_features_112,
                     "fill_features_336": fill_features_336}
